...
func ServiceConnection(ctx context.Context, serviceName string, consulClient discovery.Registry) (*grpc.ClientConn, error) {
	addrs, err := consulClient.ServiceAddresses(ctx, serviceName)
	if err != nil {
		return nil, err
	}
